...
When I first learned about Bitcoin, the first problem I thought about was its digital form. It will be easily replicated. After learning more about Bitcoin, I disproved this problem. Bitcoin is a digital currency. However, its network effect is very difficult, probably impossible, to replicate. I started thinking about why Bitcoin hasn't been widely adopted. This seems to be a harder and ongoing problem. Bitcoiners like to tout hyperbitcoinization as the future. In this future, money is based on Bitcoin. Therefore, people will use bitcoins for transactions. But Bitcoin has grown significant. There's no indication of how hyperbitcoinization will unfold. Bitcoin seems eternally unsuitable for transactions. I think the problem is its volatility. Its volatility is an inherent property of the supply cap. With a hard cap, Bitcoin is a good Store of Value. This property will prevent Bitcoin from being used as a Medium of Exchange. This is when I applied the Yin/Yang concept in Taoism. It's hard to put the exact Yin-Yang labels on phenomenon. But we can think of Bitcoin as Yang (or Qian). Something opposite of Bitcoin is Yin (or Kun).

Yi Ching an ancient Chinese classical text. Yi Ching is usually translated as Book of Changes or Classic of Changes. I (Yi) means Change. Ching means Book or Text. Its origin is unknown, mostly based on folklores. The concepts likely predated written history. People probably started writing the concepts into Yi Ching around 3000 years ago. The book evolves through 10th and 4th centuries BC into its current form. Chinese philosophical traditions, like Confucianism and Taoism, have their roots in Yi Ching. A lot of literature and interpretation around Yi Ching is about divination. Such use leads to superstitious beliefs. The impression prevents people from studying the concepts. I recently learned that the binary number system (0 and 1) has root in Yi Ching. The system is a basis for computing and information technology. Leibniz was inspired Yi Ching to create the binary number system. Yi Ching points to The Way. It is a reflection of how the universe operates. When we attempt to disturb this balance, the system can malfunction in unexpected ways.
...
We can interpret some phenomenon using Yin and Yang. Interpretations are subjective. They're not final truths. Yi Ching is a tool to help us understand.
...
Yi Ching started with 2 symbols. The world is more complicated to explain everything with only two polars. Yi Ching provides more. We can generate combinations of these 2 symbols. The next level up is called Bagua. We combine Yin and Yang 3 times. The number of combinations is 2^3 = 8.
...
We can see computing architecture has made through cycles of centralization and decentralization. We're currently in the Cloud Computing phase. It's possibly the end of this phase with consolidation of technology companies. According to the flow, we should expect to see some decentralization in the next decade. I think this change has already started with the advent of Bitcoin. People often think centralization is bad or decentralization is bad. Interpretations are usually subjective and dependent on situations. But centralization and decentralization are concepts. They're not good or bad. Misunderstanding and false promises are bad. For example, when we misread centralization as bringing more choices. With centralization, we gain efficiency but our choices are reduced. With decentralization, we lose efficiency in exchange for more choices.
...
- Censorship / Censorship Resistant: It's easier to change rules in a centralized system. We only need to update the principal agents or gatekeepers. In a decentralized system, changing rules require consensus of all agents.

- Trust / Trustless: A centralized system requires high level of trust. Rules can change by a central authority. In a decentralized system, changing rules is difficult and slow. Agents have the ability to verify rules and opt-out. If rules are not satisfactory to expectation, you can always leave the system.
...
It's easy to get confused between these trade-offs. People mix trade-offs and make confusing claims. For example, people can claim that a decentralized network only needs 20 - 30 nodes. You can achieve permissionless. From decentralization perspective, more nodes is always better (more decentralized). When we evaluate a system, more decentralization means more nodes and vice versa. Therefore, a network with 100 is better (more decentralized) than a network with 20 nodes. A network with 100k nodes is better (more decentralized) than a network with 10k nodes. We should evaluate these trade-offs independently.

### Money

Money is vital to human societies. It's a reflection of values which include many dimensions of our experience. Money exhibits many types of Yin/Yang trade-offs. To limit the scope of our discussion, I examine the relationship between Fiat money and Gold. This is the Gold Standard for money. Historically, humans have used other metals as money. But fiat money have been a more robust alternative to metal money. Within the Yi Ching framework, Gold is decentralized and fiat is centralized.
...
- Medium of Exchange / Store of Value: With stable price, fiat money is more suitable for commerce. It's hard to exchange if the medium of exchange is unstable. Gold is valuable. It is more suitable as a long-term Store of Value.

If we stick with these principles, we can have a healthy economic system. There are cycles between stability and volatility. Unfortunately, humans are not good with dealing with short-term volatility. We want stability and growth. We "fix" the system by changing rules. We deviated from the Gold Standard. This deviation happened many times in the past. The latest attempt to abandon the Gold Standard is in the 1970s. On 15 August 1971, the US terminated the exchange between the US dollar and gold. Without a monetary standard, it's easy for some groups to abuse the rules. I think this detachment increased wealth inequality. Wage increase have lagged productivity increase since the 1970s.
...
Gold rushes were boons for decentralization. People have access to new gold. That can weaken the power of existing authorities. Modern nation-states have grown fast. With the help of technology, they can become monopolies of power. Since the start of the Industrial Age, humans has mostly colonized planet Earth. There are very few places that we have not reached. It is increasingly difficult to reach the frontiers. We cannot walk down to the deepest parts of the ocean. We need expensive and high-tech submarines. It is difficult to mine more gold from the Earth surface. At the same time, central governments have accumulated the majority of gold supply. Gold has lost its decentralized properties. It has moved closer to centralization. The Gold Standard is unlikely to return. In the case of gold, we can label Yang as decentralization and Yin as centralization. Gold has started out as Yang. It's moving closer to Yin. Yi Ching provides a 64-hexagram scale. I think from pre-Industrial Age until now, gold has lost halve of its decentralization property. It has moved from (Qian / Force / 6 Yangs) to (Gou / Coupling / 5 Yangs) to (Pi / Stagnation / 3 Yangs). The below diagram illustrates gold progression from decentralization to centralization.
...
For block size, we compare Bitcoin and Bitcoin Cash. On average, the Bitcoin network produces a block every 10 minutes. Your transactions are not confirmed until they are included in a block. Block size limits the number of transactions. During peak times, transactions can overwhelm block space. Users will need to wait longer for confirmation. Bitcoin Cash is a hard fork of Bitcoin. It increases block size from 1 MB to 8 MB. Bigger blocks can store more transactions. They will reduce processing time. Bitcoin Cash later forked into 2 chains: Bitcoin Cash and Bitcoin SV. Supporters of Bitcoin Cash claim the change is vital for long-term adoption of Bitcoin. More people will be able to use Bitcoin for transactions.
...
Bitcoin Cash evaluates poorly using the Yi Ching framework. Bigger block does not move Bitcoin towards being a Medium of Exchange. Bigger block reduces decentralization. The blockchain will be bigger. Running nodes is more costly. Bitcoin's volatility is in its hard cap. To make such claim, Bitcoin Cash supporters abandon Yi Ching. But doing so violates The Way. As a result, Bitcoin Cash becomes more irrelevant over time.

#### Scarcity and Technology

For scarcity and technology, we compare Bitcoin and Ethereum. Ethereum was introduced in 2015. It's rebuilt from the ground up. It makes several major changes. Its supporters pitch Ethereum as a programmable blockchain. In addition, it has a flexible monetary policy, Minimum Necessary Issuance.

<div style="text-align: center">
  <img src="/assets/images/IChingBitcoinEthereum.png" alt="Bitcoin vs. Ethereum" width="600" />
  <br/>
...
A flexible monetary policy requires "someone" to decide. This change decreases decentralization. It moves Ethereum closer to fiat money. Programmability is also not a clear differentiation. Bitcoin is digital. It can also made to be programmable. People can move bitcoins into a centralized address and make them programmable off-chain. Under the Yi Ching framework, Ethereum does not have meaningful differentiations.
...
<div style="text-align: center">
  <img src="/assets/images/IChingBitcoinBitflate.png" alt="Bitcoin vs. Bitflate" width="600" />
  <br/>
...
Since 2008, we've been on a search for the Ideal Money. Some people think Bitcoin is It. Others have proposed their own so-called improvements to Bitcoin. Yi Ching, a 3000-year-old principle, can point us to the right direction to discover the Ideal Money.
